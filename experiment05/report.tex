...
\begin{itemize}
    ...
    \item $R_1, R_2, R_3$ are the corresponding input resistances,
    \item $R_f$ is the feedback resistance.
\end{itemize}

For the given equations:

\textbf{Circuit for \( V_{out} = 2V_1 + V_2 - V_3 \)}\\
To achieve the required weighting, we select:
\begin{equation}
    R_1 = R, \quad R_2 = 2R, \quad R_3 = R, \quad R_f = 2R.
\end{equation}
...
\draw (6.5,11) to[R,l={ \LARGE $R_2$}] (8.5,11);
\draw (10.25,10.5) node[op amp,scale=1, yscale=-1 ] (opamp2) {};
\draw (opamp2.+) to[short] (8.75,11);
\draw  (opamp2.-) to[short] (8.75,10);
\draw (11.45,10.5) to[short](11.75,10.5);
\draw (6.5,12.25) to[R,l={ \LARGE $R_1$}] (8.5,12.25);
\draw (6.5,9.5) to[R,l={ \LARGE $R_3$}] (8.5,9.5);
\draw (9,12.75) to[R,l={ \LARGE $R_f$}] (11,12.75);
\draw (11.75,10) to[R,l={ \large $R_a=R_f$}] (13.75,10);
\draw (8.5,11.5) to[short] (8.5,12.25);
\draw (8.5,12) to[short] (8.5,11);
\draw (8.5,11) to[short] (9,11);
\draw (8.5,9.5) to[short] (8.5,10);
\draw (9,10) to[short] (8.5,10);
\draw (9,11) to[short] (9,12.75);
\draw (11,12.75) to[short] (11,10.5);
\draw (11.75,10.5) to[short] (11.75,10);
\draw (13.75,10) to (13.75,9.75) node[ground]{};
\node [font=\Large] at (6,12.25) {$V_1$};
\node [font=\Large] at (6,11) {$V_2$};
\node [font=\Large] at (6,9.5) {$V_3$};
\end{circuitikz}
}%
\label{fig:my_label}
\end{figure}
